        ...
        <div class="col-lg-12">
            <h1 class="page-header">Productos
				<span class="pull-right">
					<button class="btn btn-primary btn-sm" data-toggle="modal" data-target="#addproduct"><i class="fa fa-plus-circle"></i> Agregar Nuevo Producto</button>
				</span>
			</h1>
        </div>
    </div>
				...
				<?php
					...
					?>
						<tr>
							...
							<td>
								<button class="btn btn-success btn-sm" data-toggle="modal" data-target="#editprod_<?php echo $pid; ?>"><i class="fa fa-edit"></i> Modificar</button>
