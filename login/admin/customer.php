        ...
        <div class="col-lg-12">
            <h1 class="page-header">Clientes
				<span class="pull-right">
					<button class="btn btn-primary btn-sm" data-toggle="modal" data-target="#addcustomer"><i class="fa fa-plus-circle"></i> Registrar Nuevo Cliente</button>
				</span>
			</h1>
        </div>
    </div>
				...
				<?php
					...
					?>
						<tr>
							...
							<td>
								<button class="btn btn-success btn-sm" data-toggle="modal" data-target="#edit_<?php echo $cqrow['userid']; ?>"><i class="fa fa-edit"></i> Modificar</button>
