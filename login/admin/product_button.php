        ...
        <div class="modal-dialog">
            <div class="modal-content">
				...
				<div class="container-fluid">
					...
					?>
                    <h5><center>Producto a Eliminar: <strong><?php echo $b['product_name']; ?></strong></center></h5>
				...
				<div class="container-fluid">
                    ...
                    <form role="form" method="POST" action="edit_product.php<?php echo '?id='.$pid; ?>" enctype="multipart/form-data">
                        <div class="form-group input-group">
                            <span class="input-group-addon" style="width:120px;">Nombre Producto:</span>
						...
						<div style="height:10px;"></div>
						<div class="form-group input-group">
                            <span class="input-group-addon" style="width:120px;">Categoría:</span>
